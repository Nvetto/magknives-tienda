document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        let resumenHTML = '<h3 class="text-2xl font-bold mb-6 text-center text-gray-800">Resumen de tu Pieza Personalizada</h3>';
        resumenHTML += '<div class="bg-gray-50 p-6 rounded-lg mb-6">';
        ...
        resumenHTML += `
            <div class="text-center space-y-4">
                <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <p class="text-blue-800 font-medium">¡Perfecto! Tu diseño está listo</p>
                    <p class="text-blue-600 text-sm mt-1">Para recibir tu cotización final, contáctame por WhatsApp con este resumen</p>
                </div>
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="${linkWhatsapp}" target="_blank" class="inline-flex items-center justify-center bg-green-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-green-600 transition-colors">
                    ...
                    <button onclick="document.getElementById('modalResumen').classList.add('hidden')" class="inline-flex items-center justify-center bg-gray-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-gray-600 transition-colors">
